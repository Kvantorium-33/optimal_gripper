...
#include "libs/Axis/Axis.h"                                          // БИБЛИОТЕКА ОСЕЙ 
#include "libs/Workspace/Workspace.h"                                // БИБЛИОТЕКА РАБОЧЕГО ПРОСТРАНСТВА
#include "libs/Mathematics/Mathematics.h"                            // БИБЛИОТЕКА МАТЕМАТИКИ  
#include "libs/DynamixelSerial3/DynamixelSerial3.h"
////////////////// ПОДКЛЮЧЕНИЕ БИБЛИОТЕК ПАРАМЕТРОВ И ДАННЫХ ///////////
#include "Pin_config.h"                                             // ПАРАМЕТРЫ ПИНОВ
...
Pin_config PC;                                                   // ОБЪЕКТ КОНФИГА ПИНОВ
...
{                                                                   //
    ...
    ///////////////////////// ПОДГОТОВКА МОТОРОВ ///////////////////////
    Dynamixel.begin(Conf.DXL_BAUDRATE, Conf.dir_pin);
    motor_init();
    motor_blink();
    COM.println("ready");
}
